...
impl Codec {
    ...
    fn set_register_defaults(&mut self) {
        ...
        self.register_cache[Register::LeftLineInputChannelVolumeControl as usize] = 0b0_1_0000000;
        // RightLineInputChannelVolumeControl - Right Input muted
        self.register_cache[Register::RightLineInputChannelVolumeControl as usize] = 0b0_1_0000000;
    ...
    pub fn set_line_input_mute<T>(&mut self, mute: bool, channel: Channel) {
    ...
    pub fn set_analog_input(&mut self, analog_input: AnalogInput) {
        const MASK: u16 = 1 << 2;
		self.set_register_bits(Register::AnalogAudioPathControl, (analog_input as u16) << 2, MASK);
    }
    ...
    pub fn set_microphone_boost(&mut self, boost_enabled: bool) {
        const MASK: u16 = 1 << 0;
		self.set_register_bits(Register::AnalogAudioPathControl, if boost_enabled { MASK } else { 0 }, MASK);    	
    }
    ...
    pub fn set_dac_enable(&mut self, dac_enabled: bool) {
        const MASK: u16 = 1 << 4;
		self.set_register_bits(Register::AnalogAudioPathControl, if dac_enabled { MASK } else { 0 }, MASK);    	
    }
    ...
    pub fn set_microphone_mute(&mut self, mute_enabled: bool) {
        const MASK: u16 = 1 << 1;
		self.set_register_bits(Register::AnalogAudioPathControl, if mute_enabled { MASK } else { 0 }, MASK);    	
    }
    ...
    pub fn set_bypass(&mut self, bypass_enabled: bool) {
        const MASK: u16 = 1 << 3;
		self.set_register_bits(Register::AnalogAudioPathControl, if bypass_enabled { MASK } else { 0 }, MASK);
    }
